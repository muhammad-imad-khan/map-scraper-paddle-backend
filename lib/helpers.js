...
const PRICE_CREDITS = {
  ...
  [process.env.PRICE_COURSE_INTL_ID || process.env.PRICE_COURSE_ID || 'pri_01knmdy54t0wd91ne4tspntxty']: { credits: 0, label: 'Lead Gen x AI Web Design Course', course: true },
};
