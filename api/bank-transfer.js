        ...
        <div style="font-family:Segoe UI,Arial,sans-serif;max-width:560px;margin:0 auto;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:24px;">
            ...
            <div style="margin-top:20px;text-align:center;">
              <a href="https://lead-genx.vercel.app/admin/${record.purchaseType === 'course' ? 'courses.html' : ''}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:700;font-size:14px;">Open Admin Panel</a>
            </div>
          </div>
          <div style="background:#f8fafc;padding:14px 24px;font-size:12px;color:#94a3b8;text-align:center;">
            LEAD GEN x AI Powered Tool &mdash; Bank Transfer Request
          </div>
        </div>
      `;
      transport.sendMail({
        from: `"LEAD GEN x AI Powered Tool" <${process.env.SMTP_USER}>`,
        to: ADMIN_EMAIL,
